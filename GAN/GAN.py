...
def process_data():   
    ...
    clickbait_dir = os.path.join(current_dir, 'data')
    images = []
    for each in os.listdir(clickbait_dir):
        images.append(os.path.join(clickbait_dir,each))
    # print images    
...
def train():
    ...
    for i in range(EPOCH):
        ...
        if i%50 == 0:
            ...
            save_images(imgtest, [8,8] ,newclick_path + '/epoch' + str(i) + '.jpg')
